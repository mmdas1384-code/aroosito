...
<div id="tab-home" class="tab-content space-y-12">
  ...
  <section class="quick-tools-section">
    <div class="container text-center">
      <span class="sub-title">🛠️ ابزارهای هوشمند برنامه‌ریزی عروسی</span>
  ...
  <section class="budget-calculator-section">
    <div class="dark-calc-card">
      <div class="calc-top-row">
        <a href="#" onclick="switchTab('tools'); return false;" class="btn-gold-sm">ورود به بودجه‌ریز کامل AI ←</a>
        <div class="calc-title-box">
          <span class="calc-badge">📊 پیش‌بینی هوشمند هزینه مراسم</span>
        ...
        <div class="calc-controls-box">
          ...
          <div class="style-row">
            ...
            <div class="style-btns">
              <button class="s-btn">لوکس / VIP 💎</button>
              <button class="s-btn active">متوسط ⭐️⭐️</button>
              <button class="s-btn">اقتصادی 🌸</button>
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="weddings-gallery-section">
    <div class="container">
      <div class="gallery-top-bar">
        <a href="#" onclick="switchTab('inspiration'); return false;" class="btn-gold-sm">مشاهده مجله ایده‌ها & مودبورد ←</a>
        <div class="gallery-titles">
          <span class="rose-tag">❤️ داستان‌های واقعی پیوند عشاق یزد</span>
  ...
  <section class="vendor-banner-dark">
    <div class="container flex-banner">
      <div class="banner-btns">
        <a href="#" onclick="toggleVendorModalStatic(true); return false;" class="btn-gold-md">➕ ثبت‌نام رایگان کسب‌وکار</a>
        <a href="#" onclick="switchRole('vendor'); return false;" class="btn-dark-md">🏢 ورود به پنل تامین‌کننده</a>
      </div>
      <div class="banner-info">
        <span class="badge-gold">🏢 ویژه صاحب‌امتیازان تالار، آتلیه، سالن زیبایی و خدمات مجالس یزد</span>
